...
<template>
    <Dialog>
        <DialogTrigger as-child>
            <Button variant="outline" class="font-bold">发布帖子</Button>
        </DialogTrigger>
        <DialogContent class="sm:max-w-4xl">
            ...
            <div class="grid gap-4 py-4">
                ...
                <div class="grid grid-cols-4 items-center gap-4">
                    ...
                    <Input id="postTitle" v-model="post.title" placeholder="请输入主题标题" class="col-span-3" required />
                </div>
                ...
                <div class="grid grid-cols-4 items-start gap-4">
                    ...
                    <div class="col-span-3">
                        <textarea v-model="post.content" placeholder="请输入正文"
                            class="w-full h-48 p-2 border rounded-md"></textarea>
                ...
                <div class="grid grid-cols-4 items-center gap-4">
                    ...
                    <select id="topic" v-model="post.topic" class="col-span-3 p-2 border rounded-md" required>
            ...
            <DialogFooter>
                <Button type="submit" @click="submitPost">发布主题</Button>
                <DialogTrigger>
...
const submitPost = () => {
    if (!post.value.title || !post.value.topic) {
        alert('标题和主题节点为必填项')
        return
    }
